...
export const metadata: Metadata = {
  metadataBase: new URL('https://hizkurye.com'),
  title: {
    default: 'MotoKuryeGelsin - İstanbul\'un En Hızlı Kurye Servisi',
    template: '%s | MotoKuryeGelsin'
  },
  description: 'İstanbul içi 30 dakikada güvenli teslimat. 7/24 hizmet, 39 ilçe kapsama alanı. Döküman, paket ve acil kurye hizmetleri.',
  ...
  openGraph: {
    type: 'website',
    locale: 'tr_TR',
    url: 'https://hizkurye.com',
    title: 'MotoKuryeGelsin - İstanbul\'un En Hızlı Kurye Servisi',
    description: 'İstanbul içi 30 dakikada güvenli teslimat. 7/24 hizmet, 39 ilçe kapsama alanı.',
