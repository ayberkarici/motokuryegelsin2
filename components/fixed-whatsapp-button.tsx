...
const FixedWhatsAppButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-0 left-0 right-0 md:left-1/2 md:right-auto md:-translate-x-1/2 md:bottom-6 md:w-auto w-full z-50 bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 group md:rounded-full rounded-none"
