          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                İstanbul'un
                <span className="text-yellow-400 block">Güvenilir Kurye</span>
                Hizmeti
              </h1>
              <p className="text-lg md:text-xl text-blue-100 leading-relaxed">
                İstanbul içi ve çevre illere moto kurye hizmeti. Evraklarınızdan paketlerinize kadar her türlü teslimat.
              </p>
            </div>
